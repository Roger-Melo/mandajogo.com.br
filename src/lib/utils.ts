...
export const newReleases = [
  {
    ...
    supplyPermalink: "suikoden-i-and-ii-hd-remaster-gate-rune-and-dunan-unification-wars",
    platforms: [
      { name: "Playstation 5", permalink: "ps5" },
      { name: "Nintendo Switch", permalink: "switch" }
    ],
  ...
  },
  {
    id: Math.random(),
    title: "Atomfall",
    supplyPermalink: "atomfall",
    platforms: [
      { name: "Playstation 5", permalink: "ps5" },
      { name: "Playstation 4", permalink: "ps4" }
    ],
  ...
  },
  {
    ...
    supplyPermalink: "the-first-berserker-khazan",
    platforms: [
      { name: "Playstation 5", permalink: "ps5" }
    ],
  ...
  },
  {
    ...
    supplyPermalink: "assassins-creed-shadows",
    platforms: [
      { name: "Playstation 5", permalink: "ps5" }
    ],
  ...
  },
  {
    ...
    supplyPermalink: "monster-hunter-wilds",
    platforms: [
      { name: "Playstation 5", permalink: "ps5" }
    ],
    cover: "/covers/ps5/stellar-blade.jpg",
